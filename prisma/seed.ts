...
async function main() {
  ...
  await prisma.setting.createMany({
    data: [
      ...
      { key: "primary_income", value: "6871.58", householdId: household.id },
      { key: "partner_income", value: "7155.70", householdId: household.id },
      { key: "partner_va", value: "682.00", householdId: household.id },
    ],
  });
  ...
  const recebiveisAbril = [
    { desc: "Repasse parceiro (ajuste)", amount: 171.78 },
  ...
  const despesasFixas = [
    ...
    { desc: "Água", category: "Moradia", amount: 180.0, day: 10, isVariable: true },
    { desc: "Luz", category: "Moradia", amount: 320.0, day: 15, isVariable: true },
