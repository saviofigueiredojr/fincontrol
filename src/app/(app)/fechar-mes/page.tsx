...
function normalizeMonthData(monthPayload: any, txPayload: any, competencia: string): MonthData {
  ...
  return {
    ...
    goalSuggestion: toFiniteNumber(monthPayload?.goalSuggestion ?? monthPayload?.metaAllocation ?? 4761.64),
    currentGoalAmount: toFiniteNumber(monthPayload?.currentGoalAmount ?? 0),
    goalTarget: toFiniteNumber(monthPayload?.goalTarget ?? 45000),
  };
}
...
export default function FecharMesPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setAllocation(String(normalizedMonth.goalSuggestion || 4761.64));
