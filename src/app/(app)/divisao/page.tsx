...
export default function DivisaoPage() {
  ...
  const [settings, setSettings] = useState<Settings>({ myIncome: 6871.58, partnerIncome: 7837.70 });
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (settingsRes.ok) {
        ...
        const myIncome = parseFloat(sJson.primary_income || "6871.58");
        const partnerBase = parseFloat(sJson.partner_income || "7155.70");
        const partnerVa = parseFloat(sJson.partner_va || "682.00");
